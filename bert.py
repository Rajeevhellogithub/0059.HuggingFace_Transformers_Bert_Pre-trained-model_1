# (tensorflowvenv) E:\PYTHONCLASSTF\PrakashSenapati\2024_12_11_RNN_Start_BertChatbot>streamlit run bert.py
# https://github.com/MLphile/BERT_on_Movie_Reviews/blob/main/data/IMDB_Dataset.csv (63.1 MB)
# https://www.kaggle.com/code/atulanandjha/bert-testing-on-imdb-dataset-extensive-tutorial/input (32.59 MB)
# This will take much time to load cloud 'IMDB_Dataset.csv (63.1 MB)' on your local machine

import torch
# Fundamental data structures (tensors) and functions for building and training neural networks.
from transformers import BertTokenizer, BertForSequenceClassification, Trainer, TrainingArguments
# Pre-trained transformer models (classes and modules) from the Hugging Face
from datasets import load_dataset
# Hugging Face datasets library
from fastapi import FastAPI
# Web framework for building APIs with Python
from pydantic import BaseModel
# Data validation, parsing and strucuring
import streamlit as st
# Interactive web applications in Python
import requests
# Making HTTP requests. Interact with web services and APIs
